...
/// <summary>
/// Represents a base class for value objects. A value object is an object
/// that represents descriptive aspects of the domain with no conceptual identity.
/// NOTE: If you're using C# 10 or later, it's highly recommended to consider 
/// the `readonly record struct` for scenarios where you traditionally used
/// value objects instead of this class.
/// </summary>
/// You can simply use:
/// <code>
/// public readonly record struct Address(string Street, string City, string Zip);
/// </code>
/// But if you want to use this base class, follow the below example:
/// <example>
/// Here's how you might define an `Address` class using the `ValueObject` as its base:
/// <code>
...
///     }
/// }
/// You can then use two instances of this class and check their equality based on their values:
/// var address1 = new Address("123 Main St", "Townsville", "12345");
/// var address2 = new Address("123 Main St", "Townsville", "12345");
/// var isEqual = address1 == address2; // This would be true.
/// </code>
/// </example>
[Serializable]
